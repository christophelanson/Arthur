...
if __name__ == "__main__":
    ...
    position = [90,220,150,-30,0,80] # position du point M à atteindre [directionBras(degrés), xM(mm), zM(mm), incidencePince(degrés), rotationPince(degrés), ouverturePince(degrés)]
